"""
This module contains test cases for the `calculate_and_print` function.

The tests cover various arithmetic operations (addition, subtraction, multiplication, division),
as well as error handling for invalid inputs and unknown operations.
"""
...
def test_calculate_and_print(a_string, b_string, operation_string, expected_string, capsys):
    """Tests the calculate_and_print function for different inputs and expected outputs."""
