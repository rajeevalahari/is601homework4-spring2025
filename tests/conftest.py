...
def pytest_generate_tests(metafunc):
    ...
    if {"a", "b", "expected"}.intersection(set(metafunc.fixturenames)):
        ...
        # Ensure 'a', 'b', and 'expected' are not parametrized elsewhere
        if 'a' not in metafunc.fixturenames and 'b' not in metafunc.fixturenames and 'expected' not in metafunc.fixturenames:
